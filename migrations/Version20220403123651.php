 ...
 */
final class Version20220403123651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dislike DROP FOREIGN KEY fk_user_dislike');
        ...
        $this->addSql('ALTER TABLE likes DROP FOREIGN KEY fk_like_article');
        $this->addSql('ALTER TABLE likes DROP FOREIGN KEY fk_user_like');
        ...
        $this->addSql('ALTER TABLE users CHANGE typeUser typeUser VARCHAR(7) DEFAULT \'client\' NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dislike ADD CONSTRAINT fk_user_dislike FOREIGN KEY (user_id) REFERENCES users (id) ON UPDATE CASCADE ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE likes ADD CONSTRAINT fk_like_article FOREIGN KEY (article_id) REFERENCES article (id) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('ALTER TABLE likes ADD CONSTRAINT fk_user_like FOREIGN KEY (user_id) REFERENCES users (id) ON UPDATE CASCADE ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE users CHANGE typeUser typeUser VARCHAR(7) DEFAULT NULL');
    }
}
