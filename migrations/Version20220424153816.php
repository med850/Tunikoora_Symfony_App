 ...
 */
final class Version20220424153816 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE review ADD date_review DATETIME DEFAULT NULL, ADD author VARCHAR(255) DEFAULT NULL, DROP rating');
