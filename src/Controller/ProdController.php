...
use ContainerQJl7xTU\PaginatorInterface_82dac15;
...
class ProdController extends AbstractController
{
    ...
    /**
     * @Route("proddd/", name="prodprod")
     */

    function orderByName(ProductsRepository $repository, PaginatorInterface $paginator, Request $request){

        $produit = $paginator->paginate($repository->orderByName(),
            $request->query->getInt('page', 1),
            5
        );
